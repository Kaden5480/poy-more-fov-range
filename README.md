# poy-more-fov-range
![Code size](https://img.shields.io/github/languages/code-size/Kaden5480/poy-more-fov-range?color=5c85d6)
![Open issues](https://img.shields.io/github/issues/Kaden5480/poy-more-fov-range?color=d65c5c)
![License](https://img.shields.io/github/license/Kaden5480/poy-more-fov-range?color=a35cd6)
...
which increases the configurable FOV range.
...
[here](https://github.com/Kaden5480/poy-more-fov-range/releases).
...
## Visual Studio build
To build with Visual Studio, open MoreFOVRange.sln and build by pressing ctrl + shift + b,
